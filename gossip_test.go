...
func testConfig(tb testing.TB) *Config {
	...
	config.BindPort = bindPort // choose free port.
	// config.Name = config.BindAddr
	config.Name = fmt.Sprintf("%s:%d", config.BindAddr, config.BindPort)
	if tb != nil {
...
func GetGossip(tb testing.TB, f func(c *Config)) *Gossip {
	c := testConfig(tb)
...
func TestCreate_invalidLoggerSettings(t *testing.T) {
	...
	if err == nil {
		require.NoError(t, m.Shutdown())
		t.Fatal("Gossip should not allow both LogOutput and Logger to be set, but it did not raise an error")
	}
}
...
func TestGossip_CreateShutdown(t *testing.T) {
	m := GetGossip(t, nil)
	m.schedule()
	require.NoError(t, m.Shutdown())
}

func TestGossip_ResolveAddr(t *testing.T) {
	m := GetGossip(t, nil)
	defer m.Shutdown()
...
func TestGossip_ResolveAddr_TCP_First(t *testing.T) {
	bind := "127.0.0.1:8600"
...
func TestGossip_Members(t *testing.T) {
	n1 := &Node{Name: "test"}
	n2 := &Node{Name: "test2"}
	n3 := &Node{Name: "test3"}
...
func TestGossip_Join_Cancel(t *testing.T) {
	c1 := testConfig(t)
...
func TestGossip_Join_Cancel_Passive(t *testing.T) {
	c1 := testConfig(t)
...
func TestGossip_Join_protocolVersions(t *testing.T) {
	c1 := testConfig(t)
...
func TestGossip_JoinShutdown(t *testing.T) {
	newConfig := func() *Config {
		c := testConfig(t)
...
func TestGossip_delegateMeta(t *testing.T) {
	c1 := testConfig(t)
...
func TestGossip_delegateMeta_Update(t *testing.T) {
	c1 := testConfig(t)
...
func TestGossip_UserData(t *testing.T) {
...
func TestGossip_SendTo(t *testing.T) {
...
func TestGossipProtocolVersion(t *testing.T) {
	c := testConfig(t)
...
func TestGossip_Join_DeadNode(t *testing.T) {
	c1 := testConfig(t)
...
func TestGossip_Join_Protocol_Compatibility(t *testing.T) {
...
func TestGossip_Join_IPv6(t *testing.T) {
...
func TestGossip_conflictDelegate(t *testing.T) {
	c1 := testConfig(t)
	mock := &MockConflict{}
	c1.Conflict = mock
...
func TestGossip_PingDelegate(t *testing.T) {
	newConfig := func() *Config {
		c := testConfig(t)
...
func waitUntilSize(t *testing.T, m *Gossip, expected int) {
	t.Helper()
...
func waitUntilPortIsFree(t *testing.T, m *Gossip) {
	t.Helper()
...
func TestGossip_EncryptedGossipTransition(t *testing.T) {
	...
	var bindPort int
	createOK := func(conf *Config) *Gossip {
		t.Helper()
	...
	joinOK := func(src, dst *Gossip, numNodes int) {
		t.Helper()
	...
	leaveOK := func(m *Gossip, why string) {
		t.Helper()
	...
	shutdownOK := func(m *Gossip, why string) {
		t.Helper()
	...
	leaveAndShutdown := func(leaver, bystander *Gossip, why string) {
		t.Helper()
...
// OR we must disable the address conflict checking in Gossip.
// I just comment out that code to test this case.
//
//func TestGossip_Restart_delegateMeta_Update(t *testing.T) {
//    c1 := testConfig()
//    c2 := testConfig()
//    mock1 := &MockDelegate{meta: []byte("web")}
//    mock2 := &MockDelegate{meta: []byte("lb")}
