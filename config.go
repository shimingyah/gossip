...
// Config the configurations for gossip
type Config struct {
	// The name of this node. This must be unique in the cluster.
	Name string

	// Transport is a hook for providing custom code to communicate with
	// other nodes. If this is left nil, then gossip will by default
	...
	// an indirect probe of a node in the case a direct probe fails. gossip
	...
	// this lower (more frequent) will cause the gossip cluster to detect
	...
	// data to gossip via callback mechanisms. For Delegate, see
	...
	// Size of gossip's internal channel which handles UDP messages. The
	// size of this determines the size of the queue which gossip will keep
	// while UDP messages are handled.
	HandoffQueueDepth int

	// Maximum number of bytes that gossip will put in a packet (this
...
// DefaultLANConfig returns a sane set of configurations for gossip.
...
// these values are a good starting point when getting started with gossip.
